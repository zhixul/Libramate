...
/**
 * Servlet implementation class addRead
 */
@WebServlet("/addRead")
public class addRead extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String[] readList =(String[]) session.getAttribute("read");
		...
		if(!exist) {
			...
			session.setAttribute("read", readList2);
